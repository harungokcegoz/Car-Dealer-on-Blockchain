        ...
        <div className="w-2/3">
          ...
          <div className="bg-white shadow-md rounded p-12 mb-8 flex flex-wrap">
            <div className="mb-8 pr-4 w-1/2">
              ...
              <input
                className="shadow appearance-none border rounded w-full py-3 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-xs"
                id="licensePlate"
                type="text"
                name="licensePlate"
            ...
            {/* Asking Price */}
            <div className="mb-8 w-1/2 pr-4">
              <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="askingPrice">
                Asking Price
              </label>
              <input
                className="shadow appearance-none border rounded w-full p-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-xs"
